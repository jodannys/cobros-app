  ...
  <div>
    ...
    <div class="page">
      <div class="search-bar">
        ...
        <input class="form-control" placeholder="Buscar por nombre o DNI..."
        ...
        : lista.map(c => {
            ...
            <div class="client-item" onclick="selectClient('${c.id}')">
              ...
              <span class="client-badge ${crs.length > 0 ? 'badge-active' : 'badge-done'}">
                ${crs.length > 0 ? `${crs.length} activo${crs.length > 1 ? 's' : ''}` : 'Sin crédito'}
              </span>
            </div>`;
          }).join('')}
    </div>
...
function renderClientDetail() {
  ...
  <div>
    ...
    <div class="page">
      ...
      <!-- CRÉDITOS: botón nuevo solo si NO tiene crédito activo (P5 CORREGIDO) -->
