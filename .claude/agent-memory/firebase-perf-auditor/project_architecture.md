...
- `users` — rol: admin/cobrador
- `clientes` — cobradorId asignado
- `creditos` — monto, total, cuotaDiaria, diasTotal, fechaInicio, fechaFin, activo, clienteId, cobradorId
- `pagos` — creditoId, clienteId, cobradorId, monto, aplicadoSaldo, aplicadoMora, tipo, fecha
...
El saldo de mochila = enviado + cobros + ajustesCobros + seguros - prestamos - gastos - devuelto
